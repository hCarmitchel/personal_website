...
<head>
	...
	<title>Personal Projects | Heather Carmitchel</title>
</head>
<body>
	<div id="top">
		<div id="header">
				...
				<div class="navbar">
					<div class="navbar-inner">
						<ul class="nav">
							...
							<li class="dropdown navLink active" id="portfolio">
			...
			<div class="span12">
				<div class="tabbable">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#HC" data-toggle="tab">Personal Website</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="HC">
							<br>
							<div class="row projectRow">
								<div class="span3">
									<h1>Personal Website</h1>
									<hr class="high"/>
									<p><a href="people.cis.ksu.edu/~h17">people.cis.ksu.edu/~h17</a></p>
									<p><a href="https://github.com/hCarmitchel">View on Github</a></p>
									<h6>Description</h6>
									<p>Create a personal portfolio website to gain experience and connect web presences. Also will be useful later to host CIS 598 time log.</p>
									<h6>Partner(s)</h6>
									<p>None</p>
									<h6>Technologies/Tools</h6>
									<p>Notepad++</p>
									<p>Html, CSS, JavaScript</p>
									<p><a href="http://jquery.com/">jQuery</a>, <a href="http://twitter.github.com/bootstrap/">Twitter's Bootstrap</a></p>
								</div>
								<div class="span7" style="margin-left:20px;">
									<div id="myCarouselHC" class="carousel slide">
										<div class="carousel-inner">
											<div class="active item">
												<a class="thumbnail" data-fancybox-group="personal-website" href="static/img/h17-screenshot-01.png" title="Home page"><img src="static/img/h17-screenshot-01.png" alt="Home page" /></a>
											</div>
											<div class="item">
												<a class="thumbnail" data-fancybox-group="personal-website" href="static/img/h17-screenshot-02.png" title="Advanced Resume Form"><img src="static/img/h17-screenshot-02.png" alt="Advanced Resume Form" /></a>
											</div>											
											<div class="item">
												<a class="thumbnail" data-fancybox-group="personal-website" href="static/img/h17-screenshot-03.png" title="Advanced Resume Form"><img src="static/img/h17-screenshot-03.png" alt="Advanced Resume Form" /></a>
											</div>											
											<div class="item">
												<a class="thumbnail" data-fancybox-group="personal-website" href="static/img/h17-screenshot-04.png" title="Advanced Resume Form"><img src="static/img/h17-screenshot-04.png" alt="Advanced Resume Form" /></a>
											</div>		
											<div class="item">
												<a class="thumbnail" data-fancybox-group="personal-website" href="static/img/h17-screenshot-05.png" title="Advanced Resume Form"><img src="static/img/h17-screenshot-05.png" alt="Advanced Resume Form" /></a>
											</div>
										</div>
										<a class="carousel-control left" href="#myCarouselHC" data-slide="prev">&lsaquo;</a> 
										<a class="carousel-control right" href="#myCarouselHC" data-slide="next">&rsaquo;</a>
									</div>
								</div>
							</div>				
						</div>
    ...
    //<![CDATA[
	  $(document).ready(function(){
			...
			$('a[data-toggle="tab"]').on('shown', function (e) {
				var selector = 'HC';
				if($('#HC').hasClass('active')) { selector = '#HC'; }
				$('#page').css('height', $(selector).height()+100);
				$('#content').css('height', $(selector).height()+100);
			});
		}); 
		$("a[href$='.jpg'],a[href$='.png'],a[href$='.gif'],a[href$='.PNG'],a[href$='.JPG']").fancybox({
			openEffect	: 'elastic',
			closeEffect	: 'fade',
			nextEffect : 'none',
			prevEffect : 'none',
